const scrollUp = document.querySelector('.up-btn__wrapper');
const scrollUpSvgPath = document.querySelector('.up-btn__svg-path');
...
function UpdateDashOffSet() {
  ...
  const dashOffSet =
    pageLength - (window.pageYOffset * pageLength) / currentHeight;
